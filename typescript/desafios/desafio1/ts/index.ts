interface Empleado {
  ...
  const empleado1: Empleado = { nombre: "Eduardo", montoVentas: 1000, tiempo: 5 };
  const empleado2: Empleado = { nombre: "Ana", montoVentas: 1500, tiempo: 3 };
  const empleado3: Empleado = { nombre: "Carlos", montoVentas: 800, tiempo: 8 };
  
  // Sueldo base
  const sueldoBase: number = 2000;
